    ...
    if (window.Select2 === b) {
        ...
        c = O(Object, {
            ...
            positionDropdown: function() {
                ...
                b.show(),
                this.focusSearch()),
                this.opts.dropdownAutoWidth ? (z = a(".select2-results", b)[0],
            ...
            loadMoreIfNeeded: function() {
                ...
                this.opts.query({
                    ...
                    callback: this.bind(function(c) {
                        ...
                        c.more === !0 ? (b.detach().appendTo(a).html(e.opts.escapeMarkup(K(e.opts.formatLoadMore, e.opts.element, d + 1))),
            ...
            updateResults: function(c) {
                ...
                c === !0 || this.showSearchInput !== !1 && this.opened())) {
                    ...
                    a.isArray(g) && g.length >= o && J(f.formatSelectionTooBig, "formatSelectionTooBig")))
                        return void n("<li class='select2-selection-limit'>" + K(f.formatSelectionTooBig, f.element, o) + "</li>");
                    if (d.val().length < f.minimumInputLength)
                        return n(J(f.formatInputTooShort, "formatInputTooShort") ? "<li class='select2-no-results'>" + K(f.formatInputTooShort, f.element, d.val(), f.minimumInputLength) + "</li>" : ""),
                        void (c && this.showSearch && this.showSearch(!0));
                    if (f.maximumInputLength && d.val().length > f.maximumInputLength)
                        return void n(J(f.formatInputTooLong, "formatInputTooLong") ? "<li class='select2-no-results'>" + K(f.formatInputTooLong, f.element, d.val(), f.maximumInputLength) + "</li>" : "");
                        ...
                        callback: this.bind(function(g) {
                            ...
                            if (l == this.queryCount) {
                                ...
                                if (g.hasError !== b && J(f.formatAjaxError, "formatAjaxError"))
                                    return void n("<li class='select2-ajax-error'>" + K(f.formatAjaxError, f.element, g.jqXHR, g.textStatus, g.errorThrown) + "</li>");
        ...
        e = O(c, {
            ...
            postprocessResults: function(a, b, c) {
                ...
                e.each2(function(a, b) {
                    ...
                    p(c, d) >= 0 && (b.addClass("select2-selected"),
            ...
            return this.each(function() {
                if (0 === c.length || "object" == typeof c[0])
                    ...
                    e === b)
                        return;
                    if (f = c[0],
                    "container" === f ? g = e.container : "dropdown" === f ? g = e.dropdown : (l[f] && (f = l[f]),
